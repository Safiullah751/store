  ...
  <nav class="bg-white mx-auto shadow-md py-4 px-6" x-data="{ menuOpen: false }">
    <div class="container mx-auto flex items-center justify-between font-bold">
        ...
        <div class="flex items-center w-full md:w-auto">
            <div class="w-24">
                <img src="images/Logo/weblogo.png" alt="Logo" class="hover:scale-105 transition-transform duration-300">
            </div>
        ...
        <div class="hidden md:flex items-center space-x-6">
            @guest
            <a href="{{route('login')}}" class="text-gray-700 hover:text-blue-500"><i class="fas fa-sign-in-alt"></i> ورود</a>
            <span class="border-l border-gray-300 h-6"></span>
            <a href="{{route('register')}}" class="text-gray-700 hover:text-green-500"><i class="fas fa-user-plus"></i> ثبت نام</a>
            @endguest
            ...
            <a href="" class="text-gray-700 hover:text-green-500"><i class="fas fa-shopping-cart"></i> سبد خرید</a>
            @endauth
        </div>
    ...
    <div x-show="menuOpen" x-cloak class="md:hidden bg-white w-full p-4 rounded-2xl space-y-4 shadow-md" x-transition>
        ...
        <!-- Mobile Search -->
        <div class="relative">
            <input type="text" placeholder="جستجو کالا" class="pl-10 pr-4 py-2 border rounded-full w-full focus:ring-2 focus:ring-blue-400">
            <i class="fas fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
        </div>

        <a href="{{route('login')}}" class="block text-gray-700 hover:text-blue-500"><i class="fas fa-sign-in-alt"></i> ورود</a>
        <a href="{{route('register')}}" class="block text-gray-700 hover:text-green-500"><i class="fas fa-user-plus"></i> ثبت نام</a>

        <!-- Mobile Categories Dropdown -->
        <div x-data="{ open: false }">
            <button @click="open = !open" class="w-full flex justify-between items-center text-gray-700 hover:text-blue-500">
                <div class="flex items-center">
                    <i class="fas fa-list"></i> <span class="ml-2">دسته‌بندی محصولات</span>
                </div>
            </button>
            <div x-show="open" x-cloak x-transition:enter="transition-all duration-200" x-transition:leave="transition-all duration-200" class="pl-4 space-y-2 mt-2">
                <div x-data="{ openSub: false }">
                    <button @click="openSub = !openSub" class="w-full text-gray-700 hover:text-black">الکترونیک</button>
                    <div x-show="openSub" x-cloak x-transition:enter="transition-all duration-200" x-transition:leave="transition-all duration-200" class="pl-4 space-y-1">
        ...
        <div x-data="{ openPages: false }">
            <button @click="openPages = !openPages" class="w-full flex justify-between items-center text-gray-700 hover:text-blue-500">
                <div class="flex items-center">
                    <i class="fas fa-file"></i> <span class="ml-2">صفحات</span>
                </div>
            </button>
            <div x-show="openPages" x-cloak x-transition:enter="transition-all duration-200" x-transition:leave="transition-all duration-200" class="pl-4 space-y-2 mt-2">
                <a href="#" class="block text-gray-700 hover:text-black">صفحه اول</a>
                <a href="#" class="block text-gray-700 hover:text-black">درباره ما</a>
                <a href="#" class="block text-gray-700 hover:text-black">تماس با ما</a>
            </div>
        </div>
        ...
        <div x-data="{ open: false }">
            ...
            <div x-show="open" x-cloak x-transition:enter="transition-all duration-200" x-transition:leave="transition-all duration-200" class="pl-4 mt-2">
        ...
        <a href="#" class="block text-gray-700 hover:text-green-500"><i class="fas fa-shopping-cart"></i> سبد خرید</a>
        @endauth
    </div>
</nav>
 ...
 <div class="hidden sm:flex items-center justify-between bg-white p-4 shadow-md relative font-bold">
    ...
    <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
        ...
        <!-- Main Dropdown -->
        <div x-show="open" x-cloak class="absolute right-0 w-48 bg-white shadow-lg rounded-lg mt-2 p-2 z-50" x-transition>

            <!-- Category: Electronics -->
            <div class="relative" x-data="{ openSub: false }" @mouseenter="openSub = true" @mouseleave="openSub = false">
                <a href="#" class="flex items-center justify-between p-2 text-gray-700 hover:bg-gray-100 rounded">
                    <span>الکترونیک</span>
                    <i class="fas fa-bolt"></i>
                </a>
                <!-- Sub-menu -->
                <div x-show="openSub" x-cloak class="absolute right-full top-0 w-48 bg-white shadow-lg rounded-lg p-2 z-50" x-transition>
